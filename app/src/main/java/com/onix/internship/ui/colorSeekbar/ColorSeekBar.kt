package com.onix.internship.ui.colorSeekbar
...
class ColorSeekBar(context: Context, attributeSet: AttributeSet): View(context, attributeSet){
    ...
    private var stopTouchTrack: OnStopTouchTrack? = null
    ...
    override fun onTouchEvent(event: MotionEvent?): Boolean {
        when(event?.action){
            ...
            MotionEvent.ACTION_UP -> {
                ...
                stopTouchTrack?.onStopTouchTrack()
                invalidate()
            }
        }
        return true
    ...
    fun setOnStopTouchTrack(onStopTouchTrack: OnStopTouchTrack) {
        this.stopTouchTrack = onStopTouchTrack
    }
    ...
    interface OnStopTouchTrack{
        fun onStopTouchTrack()
    }
}